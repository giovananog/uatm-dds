...
#endif
#define OPENDDS_IDL_FILE_SPECIFIC(base, index) opendds_idl_generated_uatmtypesupportimpl_cpp_4nhe1g##_##base##index
...
XTypes::TypeMap OPENDDS_IDL_FILE_SPECIFIC(get_minimal_type_map_private, 0)()
{
  ...
  tm[XTypes::TypeIdentifier(XTypes::EK_MINIMAL, XTypes::EquivalenceHashWrapper(31, 242, 6, 28, 208, 105, 241, 201, 108, 219, 22, 235, 214, 200))] = OPENDDS_IDL_FILE_SPECIFIC(minimal_to, 1)();
