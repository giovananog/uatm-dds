...
GENERATED_DIRTY = "UATMTypeSupportC.h" "UATMTypeSupportS.h" "UATMTypeSupportC.inl" "UATMTypeSupportC.cpp" "UATMTypeSupportS.cpp" "UATMC.h" "UATMS.h" "UATMC.inl" "UATMC.cpp" "UATMS.cpp" "UATMTypeSupport.idl" "UATMTypeSupportImpl.h" "UATMTypeSupportImpl.cpp"
...
"UATMTypeSupportC.h" "UATMTypeSupportS.h" "UATMTypeSupportC.inl" "UATMTypeSupportC.cpp" "UATMTypeSupportS.cpp" : $(SOURCE)  "$(ACE_ROOT)\bin\tao_idl.exe" "$(ACE_ROOT)\lib\TAO_IDL_BEd.dll" "$(ACE_ROOT)\lib\TAO_IDL_FEd.dll"
...
"UATMTypeSupport.idl" "UATMTypeSupportImpl.h" "UATMTypeSupportImpl.cpp" : $(SOURCE)  "$(DDS_ROOT)\bin\opendds_idl.exe" "$(DDS_ROOT)\dds\idl\IDLTemplate.txt"
...
"UATMTypeSupportC.h" "UATMTypeSupportS.h" "UATMTypeSupportC.inl" "UATMTypeSupportC.cpp" "UATMTypeSupportS.cpp" : $(SOURCE)  "$(ACE_ROOT)\bin\tao_idl.exe" "$(ACE_ROOT)\lib\TAO_IDL_BE.dll" "$(ACE_ROOT)\lib\TAO_IDL_FE.dll"
...
"UATMTypeSupportC.h" "UATMTypeSupportS.h" "UATMTypeSupportC.inl" "UATMTypeSupportC.cpp" "UATMTypeSupportS.cpp" : $(SOURCE)  "$(ACE_ROOT)\bin\tao_idl.exe"
