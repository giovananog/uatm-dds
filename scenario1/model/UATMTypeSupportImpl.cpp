...
XTypes::TypeMap OPENDDS_IDL_FILE_SPECIFIC(get_minimal_type_map_private, 0)()
{
  ...
  tm[XTypes::TypeIdentifier(XTypes::EK_MINIMAL, XTypes::EquivalenceHashWrapper(203, 78, 209, 7, 193, 170, 16, 253, 20, 115, 164, 230, 57, 79))] = OPENDDS_IDL_FILE_SPECIFIC(minimal_to, 2)();
  return tm;
}
