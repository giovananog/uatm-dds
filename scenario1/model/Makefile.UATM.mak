...
GENERATED_DIRTY = "UATMTypeSupportS.cpp" "UATMTypeSupportC.cpp" "UATMTypeSupportS.h" "UATMTypeSupportC.h" "UATMTypeSupportC.inl" "UATMS.cpp" "UATMC.cpp" "UATMS.h" "UATMC.h" "UATMC.inl" "UATMTypeSupportImpl.cpp" "UATMTypeSupport.idl" "UATMTypeSupportImpl.h"
...
"UATMTypeSupportS.cpp" "UATMTypeSupportC.cpp" "UATMTypeSupportS.h" "UATMTypeSupportC.h" "UATMTypeSupportC.inl" : $(SOURCE)  "$(ACE_ROOT)\bin\tao_idl.exe" "$(ACE_ROOT)\lib\TAO_IDL_BEd.dll" "$(ACE_ROOT)\lib\TAO_IDL_FEd.dll"
...
"UATMS.cpp" "UATMC.cpp" "UATMS.h" "UATMC.h" "UATMC.inl" : $(SOURCE)  "$(ACE_ROOT)\bin\tao_idl.exe" "$(ACE_ROOT)\lib\TAO_IDL_BEd.dll" "$(ACE_ROOT)\lib\TAO_IDL_FEd.dll"
...
"UATMTypeSupportImpl.cpp" "UATMTypeSupport.idl" "UATMTypeSupportImpl.h" : $(SOURCE)  "$(DDS_ROOT)\bin\opendds_idl.exe" "$(DDS_ROOT)\dds\idl\IDLTemplate.txt"
...
"UATMTypeSupportS.cpp" "UATMTypeSupportC.cpp" "UATMTypeSupportS.h" "UATMTypeSupportC.h" "UATMTypeSupportC.inl" : $(SOURCE)  "$(ACE_ROOT)\bin\tao_idl.exe" "$(ACE_ROOT)\lib\TAO_IDL_BE.dll" "$(ACE_ROOT)\lib\TAO_IDL_FE.dll"
...
"UATMS.cpp" "UATMC.cpp" "UATMS.h" "UATMC.h" "UATMC.inl" : $(SOURCE)  "$(ACE_ROOT)\bin\tao_idl.exe" "$(ACE_ROOT)\lib\TAO_IDL_BE.dll" "$(ACE_ROOT)\lib\TAO_IDL_FE.dll"
...
"UATMTypeSupportS.cpp" "UATMTypeSupportC.cpp" "UATMTypeSupportS.h" "UATMTypeSupportC.h" "UATMTypeSupportC.inl" : $(SOURCE)  "$(ACE_ROOT)\bin\tao_idl.exe"
...
"UATMS.cpp" "UATMC.cpp" "UATMS.h" "UATMC.h" "UATMC.inl" : $(SOURCE)  "$(ACE_ROOT)\bin\tao_idl.exe"
