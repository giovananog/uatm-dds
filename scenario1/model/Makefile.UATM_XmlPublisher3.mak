...
GENERATED_DIRTY = "UATMC.h" "UATMS.h" "UATMC.inl" "UATMC.cpp" "UATMS.cpp"
...
LINK32_OBJS= \
	"$(INTDIR)\dotdot\pilotManagerDP\pilotManagerPub.obj" \
	"$(INTDIR)\UATMC.obj" \
	"$(INTDIR)\UATMS.obj"
...
!IF "$(CFG)" == "Win32 Debug" || "$(CFG)" == "Win32 Release" || "$(CFG)" == "Win32 Static Debug" || "$(CFG)" == "Win32 Static Release" 
SOURCE="..\pilotManagerDP\pilotManagerPub.cpp"

"$(INTDIR)\dotdot\pilotManagerDP\pilotManagerPub.obj" : $(SOURCE)
	@if not exist "$(INTDIR)\dotdot\pilotManagerDP\$(NULL)" mkdir "$(INTDIR)\dotdot\pilotManagerDP\"
	$(CPP) $(CPP_COMMON) /Fo"$(INTDIR)\dotdot\pilotManagerDP\pilotManagerPub.obj" $(SOURCE)
...
"UATMC.h" "UATMS.h" "UATMC.inl" "UATMC.cpp" "UATMS.cpp" : $(SOURCE)  "$(ACE_ROOT)\bin\tao_idl.exe" "$(ACE_ROOT)\lib\TAO_IDL_BEd.dll" "$(ACE_ROOT)\lib\TAO_IDL_FEd.dll"
...
"UATMC.h" "UATMS.h" "UATMC.inl" "UATMC.cpp" "UATMS.cpp" : $(SOURCE)  "$(ACE_ROOT)\bin\tao_idl.exe" "$(ACE_ROOT)\lib\TAO_IDL_BE.dll" "$(ACE_ROOT)\lib\TAO_IDL_FE.dll"
...
"UATMC.h" "UATMS.h" "UATMC.inl" "UATMC.cpp" "UATMS.cpp" : $(SOURCE)  "$(ACE_ROOT)\bin\tao_idl.exe"
