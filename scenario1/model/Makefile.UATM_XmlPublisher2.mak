...
LINK32_OBJS= \
	"$(INTDIR)\dotdot\evtolManagerDP\evtolManPub.obj" \
	"$(INTDIR)\UATMC.obj" \
	"$(INTDIR)\UATMS.obj"
...
!IF "$(DEPGEN)" == ""
	...
	@echo https://github.com/DOCGroup/MPC
!ELSE
	$(DEPGEN) -I"$(ACE_ROOT)" -I"$(TAO_ROOT)" -I"$(DDS_ROOT)" -I"C:\Users\ongio_1lak36v\Downloads\OpenDDS-3.29.1\tools\rapidjson\include" -I"$(DDS_ROOT)\tools\modeling\codegen" -D_DEBUG -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -D_WINSOCK_DEPRECATED_NO_WARNINGS -D_SCL_SECURE_NO_WARNINGS -DOPENDDS_RAPIDJSON -DACE_AS_STATIC_LIBS -DTAO_AS_STATIC_LIBS -f "Makefile.UATM_XmlPublisher2.dep" "..\evtolManagerDP\evtolManPub.cpp" "UATMC.cpp" "UATMS.cpp"
!ENDIF
...
!IF "$(CFG)" == "Win32 Debug" || "$(CFG)" == "Win32 Release" || "$(CFG)" == "Win32 Static Debug" || "$(CFG)" == "Win32 Static Release" 
SOURCE="..\evtolManagerDP\evtolManPub.cpp"

"$(INTDIR)\dotdot\evtolManagerDP\evtolManPub.obj" : $(SOURCE)
	@if not exist "$(INTDIR)\dotdot\evtolManagerDP\$(NULL)" mkdir "$(INTDIR)\dotdot\evtolManagerDP\"
	$(CPP) $(CPP_COMMON) /Fo"$(INTDIR)\dotdot\evtolManagerDP\evtolManPub.obj" $(SOURCE)
