...
int ACE_TMAIN(int argc, ACE_TCHAR **argv)
{
  try
  {
    ...
    OpenDDS::Model::WriterSync ws(writer);
    {
      ...
      ar.estimated_time = "estimated_time";
    ...
    DDS::DataWriter_var writer_assign = model2.writer(Elements::DataWriters::tolPadReqDW_UASP);
    ...
    DDS::DataWriter_var writer_auth = model3.writer(Elements::DataWriters::flightAuthDW_UASP);
    ...
    OpenDDS::Model::WriterSync ws3(writer_auth);
    {
      ...
      fa.authorization_id = 1;
      fa.flight_id = 2;
      fa.approved_route_id = 3;
      fa.authority = "authority";
      fa.authorization_time = "authorization_time";
    ...
    DDS::DataWriter_var writer_rec = model4.writer(Elements::DataWriters::changeRecDW_UASP);
