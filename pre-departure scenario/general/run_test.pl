...
my $dbg_opts = " -ORBDebugLevel 10 -DCPSPendingTimeout 5";
...
if ($rtps) {
  $common_opts .= " -DCPSConfigFile rtps.ini -ORBDebugLevel 1";
}
...
$test->process("publisher10", "model/publisher10", $pub_opts);
