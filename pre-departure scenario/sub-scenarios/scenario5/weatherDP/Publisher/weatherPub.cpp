...
int ACE_TMAIN(int argc, ACE_TCHAR **argv) {
    try {
        ...
        std::mt19937 gen(rd()); 
        std::uniform_int_distribution<size_t> dis(0, weather_data.size() - 1);
        ...
        while (true) {
            ...
            fr.temperature = static_cast<CORBA::Float>(selected_weather.temperature);
            fr.wind_speed = static_cast<CORBA::Float>(selected_weather.wind_speed);            
