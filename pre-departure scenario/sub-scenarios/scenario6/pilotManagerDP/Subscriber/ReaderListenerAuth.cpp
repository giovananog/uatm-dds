      ...
      if (error == DDS::RETCODE_OK) {
        ...
        if (info.valid_data) {
          std::cout << "----------------------------------" << std::endl
                    ...
                    << "Ap Route ID: " << msg.authorization_status << std::endl
                    << "Auth Time: " << msg.authorization_time.in() << std::endl
                    << "Authority: " << msg.approved_departure_time.in() << std::endl
                    << "Authority: " << msg.approved_arrival_time.in() << std::endl
                    << "Authority: " << msg.tolpad_id.in() << std::endl
                    << "Authority: " << msg.pilot_id.in() << std::endl
                    << "Valid Until: " << msg.evtol_id.in() << std::endl;
        } else {
            rcs_.signal();
            break;
        }
