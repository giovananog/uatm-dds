...
my $dbg_opts = " -ORBDebugLevel 1 -DCPSPendingTimeout 2000";
...
$test->setup_discovery("-ORBDebugLevel 1 -DCPSPendingTimeout 100 -ORBLogFile DCPSInfoRepo.log") unless $rtps;
