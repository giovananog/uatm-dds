...
{
  return
    (strm << ACE_OutputCDR::from_string (_tao_aggregate.resource_id.in (), 10)) &&
    (strm << ACE_OutputCDR::from_string (_tao_aggregate.resource_type.in (), 10)) &&
    (strm << ::ACE_OutputCDR::from_boolean (_tao_aggregate.available)) &&
    (strm << ACE_OutputCDR::from_string (_tao_aggregate.skyport_id.in (), 20)) &&
    (strm << ACE_OutputCDR::from_string (_tao_aggregate.availability_time.in (), 10));
}
...
{
  return
    (strm >> ACE_InputCDR::to_string (_tao_aggregate.resource_id.out (), 10)) &&
    (strm >> ACE_InputCDR::to_string (_tao_aggregate.resource_type.out (), 10)) &&
    (strm >> ::ACE_InputCDR::to_boolean (_tao_aggregate.available)) &&
    (strm >> ACE_InputCDR::to_string (_tao_aggregate.skyport_id.out (), 20)) &&
    (strm >> ACE_InputCDR::to_string (_tao_aggregate.availability_time.out (), 10));
}
...
{
  return
    (strm << ACE_OutputCDR::from_string (_tao_aggregate.booking_id.in (), 20)) &&
    (strm << ACE_OutputCDR::from_string (_tao_aggregate.costumer_id.in (), 20)) &&
    (strm << ACE_OutputCDR::from_string (_tao_aggregate.flight_id.in (), 20)) &&
    (strm << ACE_OutputCDR::from_string (_tao_aggregate.skyport_id.in (), 20));
}
...
{
  return
    (strm >> ACE_InputCDR::to_string (_tao_aggregate.booking_id.out (), 20)) &&
    (strm >> ACE_InputCDR::to_string (_tao_aggregate.costumer_id.out (), 20)) &&
    (strm >> ACE_InputCDR::to_string (_tao_aggregate.flight_id.out (), 20)) &&
    (strm >> ACE_InputCDR::to_string (_tao_aggregate.skyport_id.out (), 20));
}
