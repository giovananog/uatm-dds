...
#ifndef OPENDDS_IDL_GENERATED_UATMTYPESUPPORTIMPL_H_BZ1G1Z
#define OPENDDS_IDL_GENERATED_UATMTYPESUPPORTIMPL_H_BZ1G1Z
...
struct MarshalTraits< ::UATM::bookingFlightRequest> {
  ...
  static SerializedSizeBound serialized_size_bound(const Encoding& encoding)
  {
    ...
    case Encoding::KIND_XCDR2:
      return SerializedSizeBound();
    case Encoding::KIND_UNALIGNED_CDR:
      return SerializedSizeBound(100);
    default:
      OPENDDS_ASSERT(false);
      return SerializedSizeBound();
    }
...
#endif /* OPENDDS_IDL_GENERATED_UATMTYPESUPPORTIMPL_H_BZ1G1Z */
