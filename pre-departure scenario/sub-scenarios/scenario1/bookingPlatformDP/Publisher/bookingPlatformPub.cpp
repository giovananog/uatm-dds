...
int ACE_TMAIN(int argc, ACE_TCHAR **argv)
{
  try
  {
    ...
    std::vector<FlightRequest> requests = readRequestsFromFile(filename);
        ...
        bfr.booking_id = bfr.costumer_id = CORBA::string_dup(current_request.booking_id.c_str());
        bfr.flight_id = bfr.costumer_id = CORBA::string_dup(current_request.costumer_id.c_str());
        bfr.costumer_id = bfr.costumer_id = CORBA::string_dup(current_request.costumer_id.c_str());
        bfr.skyport_id = bfr.costumer_id = CORBA::string_dup(current_request.skyport_id.c_str());
