...
!MESSAGE
!MESSAGE NMAKE /f "Makefile.UATM_XmlPublisher4.mak" CFG="Win32 Debug"
!MESSAGE
...
OUTDIR=.
INSTALLDIR=.
INTDIR=Debug\UATM_XmlPublisher4\x64

ALL : "$(INTDIR)" "$(OUTDIR)" DEPENDCHECK $(GENERATED_DIRTY) "$(INSTALLDIR)\publisher4.exe"
...
"$(INTDIR)" :
	...
	if not exist "Debug\UATM_XmlPublisher4\$(NULL)" mkdir "Debug\UATM_XmlPublisher4"
...
LINK32=link.exe
LINK32_FLAGS=advapi32.lib user32.lib /INCREMENTAL:NO ACEd.lib TAOd.lib TAO_AnyTypeCoded.lib TAO_PortableServerd.lib TAO_Valuetyped.lib TAO_CodecFactoryd.lib TAO_PId.lib TAO_BiDirGIOPd.lib OpenDDS_Dcpsd.lib OpenDDS_Tcpd.lib OpenDDS_InfoRepoDiscoveryd.lib OpenDDS_Udpd.lib OpenDDS_Multicastd.lib OpenDDS_Rtpsd.lib OpenDDS_Rtps_Udpd.lib OpenDDS_Shmemd.lib OpenDDS_Modeld.lib UATMd.lib iphlpapi.lib /libpath:"." /libpath:"$(ACE_ROOT)\lib" /libpath:"$(DDS_ROOT)\lib" /libpath:"model" /nologo /subsystem:console /debug /pdb:"$(INSTALLDIR)\publisher4.pdb" /machine:x64 /out:"$(INSTALLDIR)\publisher4.exe"
LINK32_OBJS= \
	"$(INTDIR)\dotdot\skyportOperatorDP\skyportOperatorPub.obj" \
	"$(INTDIR)\UATMC.obj" \
	"$(INTDIR)\UATMS.obj"

"$(INSTALLDIR)\publisher4.exe" : $(DEF_FILE) $(LINK32_OBJS)
	$(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<
	if exist "$(INSTALLDIR)\publisher4.exe.manifest" mt.exe -manifest "$(INSTALLDIR)\publisher4.exe.manifest" -outputresource:$@;1

!ELSEIF  "$(CFG)" == "Win32 Release"

OUTDIR=Release
INSTALLDIR=Release
INTDIR=Release\UATM_XmlPublisher4\x64
...
"$(INTDIR)" :
	...
	if not exist "Release\UATM_XmlPublisher4\$(NULL)" mkdir "Release\UATM_XmlPublisher4"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
CPP=cl.exe
...
LINK32=link.exe
LINK32_FLAGS=advapi32.lib user32.lib /INCREMENTAL:NO ACE.lib TAO.lib TAO_AnyTypeCode.lib TAO_PortableServer.lib TAO_Valuetype.lib TAO_CodecFactory.lib TAO_PI.lib TAO_BiDirGIOP.lib OpenDDS_Dcps.lib OpenDDS_Tcp.lib OpenDDS_InfoRepoDiscovery.lib OpenDDS_Udp.lib OpenDDS_Multicast.lib OpenDDS_Rtps.lib OpenDDS_Rtps_Udp.lib OpenDDS_Shmem.lib OpenDDS_Model.lib UATM.lib iphlpapi.lib /libpath:"." /libpath:"$(ACE_ROOT)\lib" /libpath:"$(DDS_ROOT)\lib" /libpath:"model" /nologo /subsystem:console  /machine:x64 /out:"$(INSTALLDIR)\publisher4.exe"
LINK32_OBJS= \
	"$(INTDIR)\dotdot\skyportOperatorDP\skyportOperatorPub.obj" \
	"$(INTDIR)\UATMC.obj" \
	"$(INTDIR)\UATMS.obj"
...
INTDIR=Static_Debug\UATM_XmlPublisher4\x64
...
!IF "$(DEPGEN)" == ""
	...
	@echo https://github.com/DOCGroup/MPC
!ELSE
	$(DEPGEN) -I"$(ACE_ROOT)" -I"$(TAO_ROOT)" -I"$(DDS_ROOT)" -I"C:\Users\ongio_1lak36v\Downloads\OpenDDS-3.29.1\tools\rapidjson\include" -I"$(DDS_ROOT)\tools\modeling\codegen" -D_DEBUG -DWIN32 -D_CONSOLE -D_CRT_SECURE_NO_WARNINGS -D_CRT_SECURE_NO_DEPRECATE -D_CRT_NONSTDC_NO_DEPRECATE -D_WINSOCK_DEPRECATED_NO_WARNINGS -D_SCL_SECURE_NO_WARNINGS -DOPENDDS_RAPIDJSON -DACE_AS_STATIC_LIBS -DTAO_AS_STATIC_LIBS -f "Makefile.UATM_XmlPublisher4.dep" "..\skyportOperatorDP\skyportOperatorPub.cpp" "UATMC.cpp" "UATMS.cpp"
!ENDIF
...
"$(INTDIR)" :
	...
	if not exist "Static_Debug\UATM_XmlPublisher4\$(NULL)" mkdir "Static_Debug\UATM_XmlPublisher4"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
CPP=cl.exe
...
INTDIR=Static_Release\UATM_XmlPublisher4\x64
...
"$(INTDIR)" :
	...
	if not exist "Static_Release\UATM_XmlPublisher4\$(NULL)" mkdir "Static_Release\UATM_XmlPublisher4"
	if not exist "$(INTDIR)\$(NULL)" mkdir "$(INTDIR)"
CPP=cl.exe
...
!IF EXISTS("Makefile.UATM_XmlPublisher4.dep")
!INCLUDE "Makefile.UATM_XmlPublisher4.dep"
!ENDIF
!ENDIF
...
!IF "$(NO_EXTERNAL_DEPS)" != "1"
!IF EXISTS("Makefile.UATM_XmlPublisher4.dep")
	@echo Using "Makefile.UATM_XmlPublisher4.dep"
!ELSE
	@echo Warning: cannot find "Makefile.UATM_XmlPublisher4.dep"
!ENDIF
!ENDIF
