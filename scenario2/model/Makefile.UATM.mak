...
GENERATED_DIRTY = "UATMTypeSupportC.cpp" "UATMTypeSupportS.cpp" "UATMTypeSupportC.inl" "UATMTypeSupportS.h" "UATMTypeSupportC.h" "UATMC.cpp" "UATMS.cpp" "UATMC.inl" "UATMS.h" "UATMC.h" "UATMTypeSupportImpl.cpp" "UATMTypeSupportImpl.h" "UATMTypeSupport.idl"
...
"UATMTypeSupportC.cpp" "UATMTypeSupportS.cpp" "UATMTypeSupportC.inl" "UATMTypeSupportS.h" "UATMTypeSupportC.h" : $(SOURCE)  "$(ACE_ROOT)\bin\tao_idl.exe" "$(ACE_ROOT)\lib\TAO_IDL_BEd.dll" "$(ACE_ROOT)\lib\TAO_IDL_FEd.dll"
...
"UATMTypeSupportImpl.cpp" "UATMTypeSupportImpl.h" "UATMTypeSupport.idl" : $(SOURCE)  "$(DDS_ROOT)\bin\opendds_idl.exe" "$(DDS_ROOT)\dds\idl\IDLTemplate.txt"
...
"UATMTypeSupportC.cpp" "UATMTypeSupportS.cpp" "UATMTypeSupportC.inl" "UATMTypeSupportS.h" "UATMTypeSupportC.h" : $(SOURCE)  "$(ACE_ROOT)\bin\tao_idl.exe" "$(ACE_ROOT)\lib\TAO_IDL_BE.dll" "$(ACE_ROOT)\lib\TAO_IDL_FE.dll"
...
"UATMTypeSupportC.cpp" "UATMTypeSupportS.cpp" "UATMTypeSupportC.inl" "UATMTypeSupportS.h" "UATMTypeSupportC.h" : $(SOURCE)  "$(ACE_ROOT)\bin\tao_idl.exe"
