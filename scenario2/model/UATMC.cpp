    ...
    const UATM::flightRoutesInfo &_tao_aggregate)
{
  return
    ...
    (strm << ACE_OutputCDR::from_string (_tao_aggregate.observation_time.in (), 10));
}
    ...
    UATM::flightRoutesInfo &_tao_aggregate)
{
  return
    ...
    (strm >> ACE_InputCDR::to_string (_tao_aggregate.observation_time.out (), 10));
}
    ...
    const UATM::flightAssign &_tao_aggregate)
{
  ...
  return
    ...
    (strm << _tao_aggregate.operator_id) &&
    (strm << ::ACE_OutputCDR::from_boolean (_tao_aggregate.assign_status)) &&
    ...
    UATM::flightAssign &_tao_aggregate)
{
  ...
  return
    ...
    (strm >> _tao_aggregate.operator_id) &&
    (strm >> ::ACE_InputCDR::to_boolean (_tao_aggregate.assign_status)) &&
    (strm >> _tao_aggregate_resources_id);
}
