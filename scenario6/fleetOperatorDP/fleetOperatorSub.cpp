...
int ACE_TMAIN(int argc, ACE_TCHAR* argv[])
{
  try {
    ...
    DDS::DataReader_var reader_rec = model.reader(Elements::DataReaders::availabilityDR_FOP);
    ...
    DDS::DataReader_var reader_auth = model.reader(Elements::DataReaders::FlightRoutesDR_FOP);
    ACE_SYNCH_MUTEX lock;
    ACE_Condition<ACE_SYNCH_MUTEX> condition(lock);
