...
GENERATED_DIRTY = "UATMC.cpp" "UATMS.cpp" "UATMS.h" "UATMC.h" "UATMC.inl"
...
LINK32_OBJS= \
	"$(INTDIR)\dotdot\fleetOperatorDP\fleetOperatorSub.obj" \
	"$(INTDIR)\UATMC.obj" \
	"$(INTDIR)\UATMS.obj"
...
!IF "$(CFG)" == "Win32 Debug" || "$(CFG)" == "Win32 Release" || "$(CFG)" == "Win32 Static Debug" || "$(CFG)" == "Win32 Static Release" 
SOURCE="..\fleetOperatorDP\fleetOperatorSub.cpp"

"$(INTDIR)\dotdot\fleetOperatorDP\fleetOperatorSub.obj" : $(SOURCE)
	@if not exist "$(INTDIR)\dotdot\fleetOperatorDP\$(NULL)" mkdir "$(INTDIR)\dotdot\fleetOperatorDP\"
	$(CPP) $(CPP_COMMON) /Fo"$(INTDIR)\dotdot\fleetOperatorDP\fleetOperatorSub.obj" $(SOURCE)
...
"UATMC.cpp" "UATMS.cpp" "UATMS.h" "UATMC.h" "UATMC.inl" : $(SOURCE)  "$(ACE_ROOT)\bin\tao_idl.exe" "$(ACE_ROOT)\lib\TAO_IDL_BEd.dll" "$(ACE_ROOT)\lib\TAO_IDL_FEd.dll"
...
"UATMC.cpp" "UATMS.cpp" "UATMS.h" "UATMC.h" "UATMC.inl" : $(SOURCE)  "$(ACE_ROOT)\bin\tao_idl.exe" "$(ACE_ROOT)\lib\TAO_IDL_BE.dll" "$(ACE_ROOT)\lib\TAO_IDL_FE.dll"
...
"UATMC.cpp" "UATMS.cpp" "UATMS.h" "UATMC.h" "UATMC.inl" : $(SOURCE)  "$(ACE_ROOT)\bin\tao_idl.exe"
