...
GENERATED_DIRTY = "UATMTypeSupportC.inl" "UATMTypeSupportS.cpp" "UATMTypeSupportC.cpp" "UATMTypeSupportS.h" "UATMTypeSupportC.h" "UATMC.inl" "UATMS.cpp" "UATMC.cpp" "UATMS.h" "UATMC.h" "UATMTypeSupport.idl" "UATMTypeSupportImpl.cpp" "UATMTypeSupportImpl.h"
...
"UATMTypeSupportC.inl" "UATMTypeSupportS.cpp" "UATMTypeSupportC.cpp" "UATMTypeSupportS.h" "UATMTypeSupportC.h" : $(SOURCE)  "$(ACE_ROOT)\bin\tao_idl.exe" "$(ACE_ROOT)\lib\TAO_IDL_BEd.dll" "$(ACE_ROOT)\lib\TAO_IDL_FEd.dll"
...
"UATMTypeSupport.idl" "UATMTypeSupportImpl.cpp" "UATMTypeSupportImpl.h" : $(SOURCE)  "$(DDS_ROOT)\bin\opendds_idl.exe" "$(DDS_ROOT)\dds\idl\IDLTemplate.txt"
...
"UATMTypeSupportC.inl" "UATMTypeSupportS.cpp" "UATMTypeSupportC.cpp" "UATMTypeSupportS.h" "UATMTypeSupportC.h" : $(SOURCE)  "$(ACE_ROOT)\bin\tao_idl.exe" "$(ACE_ROOT)\lib\TAO_IDL_BE.dll" "$(ACE_ROOT)\lib\TAO_IDL_FE.dll"
...
"UATMTypeSupportC.inl" "UATMTypeSupportS.cpp" "UATMTypeSupportC.cpp" "UATMTypeSupportS.h" "UATMTypeSupportC.h" : $(SOURCE)  "$(ACE_ROOT)\bin\tao_idl.exe"
